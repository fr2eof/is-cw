...
DROP FUNCTION IF EXISTS fn_update_expedition_status() CASCADE;
DROP FUNCTION IF EXISTS fn_audit_expedition_changes() CASCADE;
DROP FUNCTION IF EXISTS assign_crew_to_expedition(INTEGER, INTEGER) CASCADE;
DROP FUNCTION IF EXISTS adjust_inventory(INTEGER, TEXT, NUMERIC, INTEGER, TEXT) CASCADE;
DROP FUNCTION IF EXISTS recommend_crew_for_task(INTEGER, INT) CASCADE;
DROP FUNCTION IF EXISTS get_expedition_status(INTEGER) CASCADE;
DROP FUNCTION IF EXISTS check_expedition_readiness(INTEGER) CASCADE;
DROP PROCEDURE IF EXISTS start_expedition(INTEGER, TIMESTAMP WITH TIME ZONE) CASCADE;
DROP PROCEDURE IF EXISTS complete_expedition(INTEGER, TIMESTAMP WITH TIME ZONE) CASCADE;
